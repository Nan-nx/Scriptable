...
drawText(78, 15, 300, 60, "国内疫情信息", Color.white(), "a",24, "left")
...
// ######
drawText(430, 18, 190, 60, data[0].date.slice(-2)+"日新增确诊", Color.white(), "a",22, "center")
...
drawText(25+i*gap, 195, 45, 20, TodayIncr.Top10[i].name, new Color("ffffff", 0.7), "a",14, "center")//省份名称
}
...
drawText(485, 130, 190, 60, "新增Top 10", new Color("ffffff",0.7), "a",16, "left")
